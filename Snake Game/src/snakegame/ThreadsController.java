...
// controla toda a logica do  jogo, classe  mais importante do projeto
public class ThreadsController extends Thread{
    ...
    // Checking if the snake bits itself or is eating
    ...
    // return a position not occupied by snake;
    ...
    // refresh the squares thats needs to be
    ...
    // refreshes the tail of the snake, by removing the superfluos data in 
    // positions arraylist and refreshing the display of the things that is removed
